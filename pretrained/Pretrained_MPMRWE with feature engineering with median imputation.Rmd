...
# Last fit
lr_last_fit_femi <- last_fit(lr_final_workflow_femi, split = df_split,metrics = multi_metric)
lr_last_fit_femi %>% collect_metrics() %>% select(1,3) %>% View()
```
...
# Last fit
rf_last_fit_femi <- last_fit(rf_final_workflow_femi, split = df_split, metrics = multi_metric)
rf_last_fit_femi %>% collect_metrics() %>% select(1,3)
```
...
# Last fit
svm_last_fit_femi <- last_fit(svm_final_workflow_femi, split = df_split, metrics = multi_metric)
svm_last_fit_femi %>% collect_metrics() %>%  select(1,3)
```
...
# Last fit
svm_r_last_fit_femi <- last_fit(svm_r_final_workflow_femi, split = df_split, metrics = multi_metric)
svm_r_last_fit_femi %>% collect_metrics() %>% select(1,3)
```
...
# Last fit
xgb_last_fit_femi <- last_fit(xgb_final_workflow_femi, split = df_split, metrics = multi_metric)
xgb_last_fit_femi %>% collect_metrics() %>% select(1,3)
```
...
# Last fit
mlp_last_fit_femi <- last_fit(mlp_final_workflow_femi, split = df_split, metrics = multi_metric)
mlp_last_fit_femi %>% collect_metrics() %>% select(1,3)
```
...
# Last fit
bag_last_fit_femi <- last_fit(bag_final_workflow_femi, split = df_split, metrics = multi_metric)
bag_last_fit_femi %>% collect_metrics() %>% select(1,3)
```
...
# Last fit
nb_last_fit_femi <- last_fit(nb_final_workflow_femi, split = df_split, metrics = multi_metric)
nb_last_fit_femi %>% collect_metrics() %>% select(1,3)
```
...
# Last fit
dec_last_fit_femi <- last_fit(dec_final_workflow_femi, split = df_split, metrics = multi_metric)
dec_last_fit_femi %>% collect_metrics() %>% select(1,3)
```
...
# Last fit
mars_last_fit_femi <- last_fit(mars_final_workflow_femi, split = df_split, metrics = multi_metric)
mars_last_fit_femi %>% collect_metrics() %>% select(1,3)
```
...
cll_pred_femi1 <-
  df_test %>%
  bind_cols(predict(cll_st_femi,.,type = "class"))
  
cll_pred_femi1 %>% 
  accuracy(INFEC_after_diag, .pred_class)

cll_pred_femi1 %>% 
  bal_accuracy(INFEC_after_diag, .pred_class)

cll_pred_femi1 %>% 
  detection_prevalence(INFEC_after_diag, .pred_class)
...
dir.create("plot_femi_lr")
classifierplots::classifierplots_folder(
  test.y=df_lr_femi$INFEC_after_diag,
  pred.prob = df_lr_femi$.pred_1,
  folder = "plot_femi_lr",
  height = 250,
  width = 250
)
...
dir.create("plot_femi_rf")
classifierplots::classifierplots_folder(
  test.y=df_rf_femi$INFEC_after_diag,
  pred.prob = df_rf_femi$.pred_1,
  folder = "plot_femi_rf",
  height = 250,
  width = 250
)
...
dir.create("plot_femi_svm")
classifierplots::classifierplots_folder(
  test.y=df_svm_femi$INFEC_after_diag,
  pred.prob = df_svm_femi$.pred_1,
  folder = "plot_femi_svm",
  height = 250,
  width = 250
)
...
dir.create("plot_femi_svm_r")
classifierplots::classifierplots_folder(
  test.y=df_svm_r_femi$INFEC_after_diag,
  pred.prob = df_svm_r_femi$.pred_1,
  folder = "plot_femi_svm_r",
  height = 250,
  width = 250
)
...
dir.create("plot_femi_xgb")
classifierplots::classifierplots_folder(
  test.y=df_xgb_femi$INFEC_after_diag,
  pred.prob = df_xgb_femi$.pred_1,
  folder = "plot_femi_xgb",
  height = 250,
  width = 250
)
...
dir.create("plot_femi_nb")
classifierplots::classifierplots_folder(
  test.y=df_nb_femi$INFEC_after_diag,
  pred.prob = df_nb_femi$.pred_1,
  folder = "plot_femi_nb",
  height = 250,
  width = 250
)
...
dir.create("plot_femi_mlp")
classifierplots::classifierplots_folder(
  test.y=df_mlp_femi$INFEC_after_diag,
  pred.prob = df_mlp_femi$.pred_1,
  folder = "plot_femi_mlp",
  height = 250,
  width = 250
)
...
dir.create("plot_femi_bag")
classifierplots::classifierplots_folder(
  test.y=df_bag_femi$INFEC_after_diag,
  pred.prob = df_bag_femi$.pred_1,
  folder = "plot_femi_bag",
  height = 250,
  width = 250
)
...
dir.create("plot_femi_dec")
classifierplots::classifierplots_folder(
  test.y=df_dec_femi$INFEC_after_diag,
  pred.prob = df_dec_femi$.pred_1,
  folder = "plot_femi_dec",
  height = 250,
  width = 250
)
...
dir.create("plot_femi_mars")
classifierplots::classifierplots_folder(
  test.y=df_mars_femi$INFEC_after_diag,
  pred.prob = df_mars_femi$.pred_1,
  folder = "plot_femi_mars",
  height = 250,
  width = 250
)
...
dir.create("plot_femi_cll_st")
classifierplots::classifierplots_folder(
  test.y=df_cll_st_femi$INFEC_after_diag,
  pred.prob = df_cll_st_femi$.pred_1,
  folder = "plot_femi_cll_st",
  height = 250,
  width = 250
)
